...
export default function decorate(block) {
  ...
  if (!isSingleSlide) {
    ...
    slideIndicatorsNav.setAttribute('aria-label', placeholders.showSlide || 'Carousel Pagination');
  ...
  slideWrapper.classList.add('carousel-hero-slides');
  block.prepend(slideWrapper);
